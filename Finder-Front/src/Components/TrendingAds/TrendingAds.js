							...
							<div className="product-item bg-light">
								<div className="card">
									<div className="thumb-content">
										...
										<a href="single.html">
											<img className="card-img-top img-fluid" src="assets/images/products/products-1.jpg"
												alt="Card image cap"/>
										</a>
									</div>
							...
							<div className="product-item bg-light">
								<div className="card">
									<div className="thumb-content">
										{/* <!-- <div className="price">$200</div> --> */}
										<a href="single.html">
											<img className="card-img-top img-fluid" src="assets/images/products/products-2.jpg"
												alt="Card image cap"/>
										</a>
									</div>
									<div className="card-body">
							...
							<div className="product-item bg-light">
								<div className="card">
									<div className="thumb-content">
										{/* <!-- <div className="price">$200</div> --> */}
										<a href="single.html">
											<img className="card-img-top img-fluid" src="assets/images/products/products-3.jpg"
												alt="Card image cap"/>
										</a>
									</div>
									<div className="card-body">
